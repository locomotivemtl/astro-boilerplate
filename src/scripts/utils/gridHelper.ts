 ...
 *
 */
function setGridHelperStyles($container: HTMLElement, gutterCssVar: string, marginCssVar: string) {
 ...
 *
 */
function setGridHelperColumns($container: HTMLElement, rgbaColor: string) {
    // Clear columns
    $container.innerHTML = '';
 ...
 *
 */
function setGridEvents($container: HTMLElement, rgbaColor: string) {
    // Handle resize
